...
.dsh-cost-fab:hover{background:var(--dsw-alias-interactive-bg-hover)}
...
`;
		...
		function CostPanel({ sessions }) {
			...
			if (!open) {
				return react.createElement("div", { className: "dsh-cost-fab", title: T.title, onClick: () => setOpen(true) },
					"DeepSeek 费用"
				);
			}
